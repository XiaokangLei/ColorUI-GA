<template>
    <view style="height: 100%">
        <!-- pages/template/music/home/home.wxml -->

        <cu-custom bgColor="bg-white" :isBack="true">
            <view slot="content">音乐播放UI设计</view>
        </cu-custom>
        ...
        <scroll-view scroll-y class="scrollPage cu-timeline bg-gray">
            <view class="nav-list margin-top">
                <navigator
                    open-type="navigate"
                    hover-class="none"
                    :url="'/pages/template/music/' + item.name + '/' + item.name"
                    class="nav-lie"
...
// pages/template/music/home/home.js
export default {
    components: {
        copyright
    },
...
<style>
/* pages/template/music/home/home.wxss */
</style>
