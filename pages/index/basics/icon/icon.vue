<template>
    <view style="height: 100%">
        ...
        <view class="cu-list grid col-4 bg-white margin-sm radius-lg">
            <view class="cu-item text-xxxl text-black" v-if="item.isShow" v-for="(item, index) in iconNew" :key="index">
        ...
        <view class="cu-list grid col-4 bg-white margin-sm radius-lg">
            <view class="cu-item text-black" v-if="item.isShow" v-for="(item, index) in icon" :key="index">
...
<style>
/* pages/index/basics/icon/icon.wxss */
</style>
